...
- Format lyrics for ElevenLabs Music v2. Square brackets contain only structural section names such as [Intro], [Verse 1], [Pre-Chorus], [Chorus], [Verse 2], [Bridge], and [Final Chorus]. Never put instruments, vocal styles, moods, dynamics, or comma-separated production metadata inside square brackets.
- Use curly braces only for a short event that happens at that exact point, such as {guitar solo}, {instrumental break}, or {drum fill}. Put broad arrangement and vocal direction in STYLE, not in the lyrics.
