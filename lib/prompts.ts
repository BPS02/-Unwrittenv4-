...
- Use varied Suno-style performance meta tags throughout every song. Every section label must combine its structural name with at least one useful arrangement, instrument, vocal, mood, or dynamic direction, for example [Verse 1, Fingerstyle guitar, Close vocal] or [Final Chorus, Full band, Backing vocals]. Include at least four non-structural performance directions across the song. Tags must describe real musical changes and remain inside square brackets; never turn them into sung lyric lines.
